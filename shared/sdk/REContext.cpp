...
namespace sdk {
    ...
    void VM::update_pointers() {
        ...
        if (s_global_context != nullptr && *s_global_context != nullptr) {
            ...
            if (sdk::memory::IsBadMemPtr(false, *static_tbl, sizeof(void*)) || ((uintptr_t)*static_tbl & (sizeof(void*) - 1)) != 0) {
                ...
                for (auto i = sizeof(void*); i < 0x100; i+= sizeof(void*)) {
                    ...
                    if (sdk::memory::IsBadMemPtr(false, ptr, sizeof(void*)) || ((uintptr_t)ptr & (sizeof(void*) - 1)) != 0) {
                        continue;
                    }
